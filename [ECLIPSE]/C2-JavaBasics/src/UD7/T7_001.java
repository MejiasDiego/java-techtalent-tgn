...
public class T7_001 {
    ...
    for (Map.Entry<String, Double> entry : evaluacionAlumnos.entrySet()) {
        ...
        System.out.println("Nombre: " + nombreAlumno + ", Nota Media: "
        		+notaMedia);	
    }
        JOptionPane.showMessageDialog(null,"Media aritmética "
        				+ "de cada alumno: \n" +evaluacionAlumnos);
	...
	int cantidadNotas = Integer.parseInt(JOptionPane.showInputDialog(
                "Introduce la cantidad de notas para el alumno " + nombre + ":"));
