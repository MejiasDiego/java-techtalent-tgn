...
public class UD18_07 {
    ...
    public static void main(String[] args) {
        ...
        String atributos3 = "(" + "  `cientifico` varchar(8) NOT NULL,"
                ...
                + "  CONSTRAINT `FK_asignado_A_cientificos` FOREIGN KEY (`cientifico`) REFERENCES `cientificos` (`DNI`) ON DELETE CASCADE ON UPDATE CASCADE,"
                + "  CONSTRAINT `FK_asignado_A_proyecto` FOREIGN KEY (`proyecto`) REFERENCES `proyecto` (`id`) ON DELETE CASCADE ON UPDATE CASCADE"
                + ")";
