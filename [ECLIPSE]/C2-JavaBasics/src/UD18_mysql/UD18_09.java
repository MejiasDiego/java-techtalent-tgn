...
public class UD18_09 {
    ...
    public static void main(String[] args) {
        ...
        String atributos2 = "(" + "  `DNI` varchar(8) NOT NULL,"
                ...
                + "  KEY `FK_investigadores_facultad` "
                + "(`facultad`),"
                + "  CONSTRAINT `FK_investigadores_facultad` "
        ...
        String atributos3 = "(" + "  `numSerie` char(4) NOT NULL,"
                ...
                + "  CONSTRAINT `FK_equipos_facultad`"
                + " FOREIGN KEY (`facultad`) REFERENCES `facultad` (`codigo`)"
                + " ON DELETE CASCADE ON UPDATE CASCADE"
                + ")";
        String atributos4 = "(" + "  `DNI` varchar(8),"
                ...
                + "  CONSTRAINT `FK_reserva_investigadores` "
                + "FOREIGN KEY (`DNI`) REFERENCES `investigadores` (`DNI`) "
                + "ON DELETE CASCADE ON UPDATE CASCADE,"
                + "  CONSTRAINT `FK_reserva_equipos` "
